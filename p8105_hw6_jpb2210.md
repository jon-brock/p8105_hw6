...
lm_output <- list(
        broom::glance(fit) %>% summarize(r.squared),
        broom::tidy(fit) %>% summarize(log_b0xb1 = log((estimate[1]*estimate[2])))
)
...
![](p8105_hw6_jpb2210_files/figure-gfm/fit%20linear%20model-1.png)<!-- -->
