...
As for the density plot of \[log(\beta_1*\beta_0)\], we see that the
distribution is normal, and centered around a \[log(\beta_1*\beta_0)\]
value of \~2.025.

The 95% confidence interval of \[log(\beta_1*\beta_0)\] is (1.96, 2.06).
